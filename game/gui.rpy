...
define gui.text_font = "monacottf.ttf"

## The font used for character names.
define gui.name_text_font = "monacottf.ttf"

## The font used for out-of-game text.
define gui.interface_text_font = "monacottf.ttf"
...
define gui.name_xpos = 528
define gui.name_ypos = 204
...
define gui.quick_button_text_idle_color = '#111111'
...
define gui.choice_button_width = 254
define gui.choice_button_height = 66
define gui.choice_button_tile = False
define gui.choice_button_borders = Borders(2, 2, 2, 2)
define gui.choice_button_text_font = gui.text_font
define gui.choice_button_text_size = 12
...
define gui.slot_button_width = 184
define gui.slot_button_height = 138
...
define config.thumbnail_width = 171
...
define gui.skip_frame_borders = Borders(11, 4, 34, 4)
...
define gui.history_height = 94

## The position, width, and alignment of the label giving the name of the
## speaking character.
define gui.history_name_xpos = 104
define gui.history_name_ypos = 0
define gui.history_name_width = 104
define gui.history_name_xalign = 1.0

## The position, width, and alignment of the dialogue text.
define gui.history_text_xpos = 114
define gui.history_text_ypos = 2
define gui.history_text_width = 494
...
define gui.nvl_thought_width = 520
...
init python:
    ...
    def small():
        ...
        gui.name_xpos = 572
        gui.dialogue_xpos = 56
        gui.dialogue_width = 734

        ## Change the size and spacing of various things.
        gui.slider_size = 24

        gui.choice_button_width = 827
        gui.choice_button_text_size = 20

        gui.navigation_spacing = 14
        gui.pref_button_spacing = 7

        gui.history_height = 127
        gui.history_text_width = 460
        ...
        gui.nvl_name_width = 204
        gui.nvl_name_xpos = 217

        gui.nvl_text_width = 610
        gui.nvl_text_xpos = 230
        gui.nvl_text_ypos = 4

        gui.nvl_thought_width = 827
        gui.nvl_thought_xpos = 14

        gui.nvl_button_width = 827

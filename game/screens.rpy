...
style window:
    ...
    background Image("gui/textbox.png", yalign=1.0)
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Registro") action ShowMenu('history')
            textbutton _("Saltar") action Skip() alternate Skip(fast=True, confirm=True)
            textbutton _("Auto-saltar") action Preference("auto-forward", "toggle")
